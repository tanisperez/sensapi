...
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/3.4.0-M3/reference/packaging/native-image/introducing-graalvm-native-images.html)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/3.4.0-M3/how-to/aot.html)
...
```
$ docker run --rm -p 8080:8080 sensapi:0.0.1-SNAPSHOT
```
